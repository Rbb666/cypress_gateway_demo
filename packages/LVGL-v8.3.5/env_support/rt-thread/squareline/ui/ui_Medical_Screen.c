...
void ui_Medical_Screen_screen_init(void)
{
    ...
    lv_obj_add_flag(ui_IMG_Wifi, LV_OBJ_FLAG_HIDDEN | LV_OBJ_FLAG_ADV_HITTEST);     /// Flags
    ...
    lv_obj_set_style_radius(ui_IMG_BTN_Bg, 100, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_BTN_Power = lv_obj_create(ui_IMG_BTN_Bg);
    lv_obj_set_width(ui_BTN_Power, 55);
    lv_obj_set_height(ui_BTN_Power, 55);
    lv_obj_set_align(ui_BTN_Power, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_BTN_Power, LV_OBJ_FLAG_CHECKABLE);     /// Flags
    lv_obj_set_style_radius(ui_BTN_Power, 160, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_shadow_width(ui_BTN_Power, 15, LV_PART_MAIN | LV_STATE_CHECKED);
    lv_obj_set_style_shadow_spread(ui_BTN_Power, 2, LV_PART_MAIN | LV_STATE_CHECKED);
